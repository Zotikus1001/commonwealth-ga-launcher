...
export const IPC = {
  ...
  downloadLauncherUpdate: 'launcher:download-launcher-update',
  ...
  openPvpReports: 'launcher:open-pvp-reports',
  getPvpReminderState: 'launcher:get-pvp-reminder-state',
  setPvpEventReminder: 'launcher:set-pvp-event-reminder',
