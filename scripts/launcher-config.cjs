  ...
  return {
    ...
    dlcs: [
      ...
      },
      {
        ...
        mapCount: 2,
        description:
          'Adds Central Industrial Complex and Recycling Plant 37 as two PvE maps, including their required support files. Remove restores saved pre-install copies and then clears their backups, falling back to verified base-game files when needed.',
